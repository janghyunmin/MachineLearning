...
# ================================
data_path = "./Data/Option_Data.csv"  # 상대경로
...
# 5. Compile
# ================================
model_relu.compile(loss="mae", optimizer="adam")

# ================================
# 6. Train (Epochs=10,000)
# ================================
...
plt.plot(history_relu.history['loss'], label='Training MAE')
plt.plot(history_relu.history['val_loss'], label='Validation MAE')
plt.xlabel('Epochs')
plt.ylabel('MAE')
